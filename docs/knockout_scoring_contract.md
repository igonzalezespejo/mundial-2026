...
- **Dieciseisavos (R32):**
  ...
  - Slot exacto: +10 pts si el equipo está además en la misma posición del cruce oficial.
  - Resultado exacto: +20 pts si el cruce es 100% exacto y se acierta el marcador (máx 60).
- **Octavos (R16):** 40 pts base por equipo clasificado. +40 extra si cruce y marcador son exactos (máx 120).
- **Cuartos (QF):** 60 pts base. +60 extra (máx 180).
- **Semifinales (SF):** 80 pts base. +80 extra (máx 240).
- **Tercer Puesto:** 100 pts base. +100 extra (máx 300).
- **Final:** 150 pts base. +150 extra (máx 450).
